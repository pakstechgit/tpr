<div class="px-15px px-lg-25px">
  ...
  <div class="aiz-titlebar text-left mt-2 mb-3">
    <h5 class="mb-0 h6">Item Option Information</h5>
  </div>

  <div class="col-lg-8 mx-auto">
    <div class="card">
      <div class="card-body p-0">
        <?php echo form_open('admins/item_options/update/'.$OPTION->id,array('class'=>'p-4'))?>
          <div class="form-group row">
            <label class="col-sm-3 col-from-label" for="name">Name</label>
            <div class="col-sm-9">
              <input type="text" placeholder="Name" id="name" name="name" value="<?=$OPTION->name?>" class="form-control" required>
            </div>
          </div>
          <div class="form-group row">
            <label class="col-sm-3 col-from-label" for="level">Level</label>
            <div class="col-sm-9">
              <input type="text" placeholder="Level" id="level" name="level" value="<?=$OPTION->level?>" class="form-control" required>
            </div>
          </div>
          <!--<div class="form-group row">-->
