<div class="px-15px px-lg-25px">
  <div class="aiz-titlebar text-left mt-2 mb-3">
    <div class="align-items-center">
      <h1 class="h3">All Market Segments</h1>
    </div>
  </div>
      ...
      <div class="card">
        <div class="card-header row gutters-5">
          <div class="col text-center text-md-left">
            <h5 class="mb-md-0 h6">Market Segments</h5>
          </div>
          <div class="col-md-4">
        ...
        <div class="card-body">
          <table class="table aiz-table mb-0">
            ...
            <tbody>
<?php foreach($MARKET_SEGMENTS_LIST as $segment) { ?>
              <tr>
                <td><?=$segment->id?></td>
                <td><?=$segment->name?></td>
                <td class="text-right">
                  <a class="btn btn-soft-primary btn-icon btn-circle btn-sm"
                    href="<?=site_url('admins/market_segments/edit/'.$segment->id)?>" title="Edit">
                    <i class="las la-edit"></i>
                  </a>
                  <a href="#" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete"
                    data-href="<?=site_url('admins/market_segments/destroy/'.$segment->id)?>" title="Delete">
    ...
    <div class="col-md-5">
      <div class="card">
        <div class="card-header">
          <h5 class="mb-0 h6">Add New Market Segments</h5>
        </div>
        <div class="card-body">
        <?php echo form_open('admins/market_segments/save') ?>
