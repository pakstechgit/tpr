  ...
  <div class="col-lg-8 mx-auto">
    <div class="card">
      <div class="card-body p-0">
        <?php echo form_open('admins/brands/update/'.$BRAND->id,array('class'=>'p-4'))?>
...
<?php foreach($CATEGORIES as $category) : ?>
                        <option value="<?=$category->id?>" <?=in_array($category->id,json_decode($BRAND->category_ids))? 'selected' : '' ?> ><?=$category->name?></option>
<?php endforeach ?>
                    </select>
                  </div>
            </div>
