  ...
  <div class="row">
    <div class="col-lg-8 mx-auto">
      <div class="card">
        ...
        <div class="card-body">
        <?php echo form_open('admins/categories/update/'.$CATEGORY->id) ?>
            <div class="form-group row">
              <label class="col-md-3 col-form-label">Name</label>
              <div class="col-md-9">
                <input type="text" placeholder="Name" value="<?=$CATEGORY->name?>" id="name" name="name" class="form-control" required />
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class="col-md-9">
                <select class="select2 form-control aiz-selectpicker" name="parent_id" data-toggle="select2"
                  data-placeholder="Choose ..." data-live-search="true">
                    ...
                    <!--call the function to generate option 
                    note that this function can be found in the controller-->
<?php generate_options($CATEGORIES, 0, 0,$CATEGORY); ?>
                </select>
              </div>
            </div>
            <!--<div class="form-group row">-->
