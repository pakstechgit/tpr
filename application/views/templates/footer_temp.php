<footer class="bg-primary p-1 p-md-5 " style="z-index:1">

    <section class="text-center justify-content-center p-5">

        <div class="footer_logo text-center w-max m-auto">
    ...
    <section class="mt-3">
        ...
        <div class="container-fluid">
            <div class="row ">
                <div class=" col col-12 text-white col-md-2" style="font-size:14px">
                    <p class="mb-3">“Your One-Stop Shop for your Healthcare Needs”</p>
                    <br>
                    <p class="mb-3">We offer wholesale pricing to all our clients. Our goal is provide high quality products at a low price.</p>
                    <p class="mb-3">Privacy and Policy</p>
                </div>

                <div class="col-sm-6 col-md-1 text-white" style="font-size:14px">
                    <p class="text-500">COMPANY</p>
                    <br>
                    <p class="p-0">Overview</p>
                    <p class="p-0">Core Values</p>
                    <p class="p-0">Mission & Vision</p>
                    <p class="p-0">Brands</p>
                </div>

                <div class="col d-md-flex justify-content-center text-white" style="font-size:14px">
                    <div class="w-max">
                ...
                <div class="col col-md-2 text-white" style="font-size:14px">
            ...
            <p class="text-center text-white"><span class="text-600 text-center ">TRP Medical</span> Copyright c 2023 All rights reserved.</p>
