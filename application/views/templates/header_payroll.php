...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        <li class="nav-item nav-size">
                            <a href="<?= base_url(); ?>home" class='nav-link <?php if ($url_directory == 'home') { echo 'active'; } ?>' style="width: 100% !important;">
                        ...
                        <li class="nav-item nav-size <?= $data['DISP_PAYROLL_STATUS']['value'] == '0' || preg_match("/payroll_modules/i", $modules['user_modules']) == FALSE  ? 'inactive' : '' ?>  ">
                            <a href="<?= base_url() ?><?= $this->session->userdata('SESS_SPE_ACCOUNT')?'payrollaccount/payroll':'payrolls'?> " class="nav-link <?php if (($this->uri->segment(1) == 'payrolls' || $this->uri->segment(1) == 'payrollaccount')) { echo 'active';} ?>">
                                <i class="nav-icon fa-duotone fa-money-from-bracket"></i>
                                <p>&nbsp;Payroll</p>
                            </a>
                        </li>

                        <li class="nav-item nav-size <?= $this->session->userdata('SESS_SPE_ACCOUNT') ? 'active' : 'inactive' ?> ">
                        ...
                        ?>
                            <li class="nav-item nav-size">
                                <a href="<?= base_url() ?>superadministrators" class="nav-link <?php if (($this->uri->segment(1) == 'superadministrators')) { echo 'active'; } ?>">
    ...
    <div class="mob-footer fixed-bottom bg-white pt-0 mt-0 " style="height: 50px; box-shadow: 0px -1px 10px rgb(0 0 0 / 15%) !important">
        <div class="row align-items-center pl-2 pr-2">
            ...
            <div class="col pt-0 mt-0">
                <a href="<?= base_url() ?>attendance/my_daily_time_record" class="text-reset d-block text-center pb-2 pt-2">
                    ...
                    <span class="d-block">
                        <font size="1">Time&nbsp;Record</font>
                    </span>
                </a>
            </div>
            <div class="col pt-0 mt-0">
                <!-- <?= base_url() ?> notification/my_notification -->
                <a href="#" class="text-reset d-block text-center">
                    <!-- <i class="fas fa-circle" style = "color: red;"></i> -->
                    <center>
                        <div class="numberCircle">
                            <span><?= $count_notif_appl + $count_notif_appl ?></span>
                        </div>
                    </center>
                    <span class="d-block">
                        <font size="1">Notifications</font>
                    </span>
                </a>
            </div>
            <div class="col pt-0 mt-0">
            ...
            <div class="col pt-0 mt-0">
                <a href="<?php echo base_url() . 'attendance/my_overtime'; ?>" class="text-reset d-block text-center pb-2 pt-2 ">
                    ...
                    <span class="fs-1">
                        <font size="1">Overtime</font>
                    </span>
                </a>
            </div>
            <!-- <div class="col">
                <a href="https://technos-systems.com/_eyeboxroot/payroll/my_payslips" class="text-reset d-block text-center pb-2 pt-3 " >
                    <span class="d-block mx-auto">
