...
<body class="container-fluid p-0 m-0">
    <header class=" bg-white" style="z-index:100;top:-1px">
        ...
        <section class="text-center p-3 position-relative" style="height:70px">
            ...
            <div class=" flag-container position-absolute h-100 d-flex justify-content-center align-items-center top-0 p-2 " style="right:65px">
                ...
                <div class="row">
                        ...
                        <div class="logo-container h-100 p-1 text-white d-flex justify-content-center align-items-center">
                            ...
                            <div class="logo_container">
                                <a href="<?= base_url('homepage'); ?>">
                                    <img style="max-width:58px;max-height:52px" class="img-fluid" src="<?= base_url("assets/images/tpr_logo_white.png") ?>" alt="tpr logo">
                                </a>
                    ...
                    <div class="col-3">
                        ...
                        <div class=" h-100 w-100  p-2 m-0 d-flex justify-content-evenly align-items-center">
                            ...
                            <div class="p-2 m-0 d-flex justify-content-between align-items-center  h-100 text-white " style="width:150px;">

                                <div class="m-2" style="width:35px;height:35px">

                                    <img src="<?= base_url("assets/icons/user_icon.png") ?>" alt="user icon">

                                </div>

                                <div class="m-2" style="font-size:12px;max-width:106px">Welcome Login/Signup</div>

                            </div>

                            <hr class="border border-white" style="height:45px">
        ...
        <section>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white shadow" style="height:80px">
    ...
    <footer class="bg_primary p-5" style="z-index:1">
        ...
        <section class="text-center">
            ...
            <div class="footer_logo text-center">
                ...
                <img src="<?= base_url("assets/images/tpr_logo_white.png") ?>" class="img-fluid d-block m-auto" alt="tpr logo">
