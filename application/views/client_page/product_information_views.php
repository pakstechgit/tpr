<style>
    ...
    <div class="p-5 w-100">
        <section class="container-fluid mt-3">
            <p class="text-secondary">Home / Products / Sharps Container</p>
        </section>
                ...
                <div class="col-md-6 p-0 w-max">
                    <div class="container-fluid  p-0 m-0 d-flex justify-content-arround">
                        <div class="d-flex flex-column ">
                            <img style="width:8vw;height:8vw" class="img-fluid mb-2" src="<?=base_url('assets/images/sharp_3.jpg')?>" alt="image info"/>
                            <img style="width:8vw;height:8vw" class="img-fluid mb-2" src="<?=base_url('assets/images/sharp_4.jpg')?>" alt="image info"/>
                            <img style="width:8vw;height:8vw" class="img-fluid mb-2" src="<?=base_url('assets/images/sharp_3.jpg')?>" alt="image info"/>
                            <img style="width:8vw;height:8vw" class="img-fluid mb-2" src="<?=base_url('assets/images/sharp_2.jpg')?>" alt="image info"/>
                            <img style="width:8vw;height:8vw" class="img-fluid mb-2" src="<?=base_url('assets/images/sharp_1.jpg')?>" alt="image info"/>
                        </div>
                        <div class="d-flex ms-3 justify-content-center align-items-center">
                            <div class="img-container  w-100 h-100">
                                <img style="object-fit:cover; width:28vw;height:42vw" class="" src="<?=base_url('assets/images/lg-sharp_container.jpg')?>" alt="image info"/>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <h3 class="text-600">Sharps Container</h3>
                    ...
                    <div class="container-fluid p-0 m-0">
                        <table class="table w-100 table-borderless table-striped">
                            <thead class="text_primary text-center">
                                <tr class="text-600">
                                <th>Item No.</th>
                                <th class="w-max text-center">Product Description</th>
                                <th>Per/Case</th>
                                <th>Price</th>
                                <th>Per/Box</th>
                                <th>Price</th>
                            ...
                            <tr class="my-3 text-600">
                                <td>4629</td>
                                <td class="text-center">2 gal</td>
                                <td class="text-center">
                                    <span class="d-block text-center">24</span>
                            ...
                            <tr class="my-3 text-600  text-danger ">
                                <td>4624</td>
                                <td class="text-center">2 gal</td>
                                <td class="text-center">
                                    <span class="d-block text-center">24</span>
                                    <div class="border d-none justify-content-evenly align-items-center p-1  border-2 border-secondary text-center rounded-pill">
                                        <span class="btn-sub d-block">-</span>
                                        <span class="qty d-block">0</span>
                                        <span class="btn-add d-block">+</span>
                                    </div>
                                ...
                                <td class="text-center align-middle">
                                    <button class="disabled text-danger border-0 add_cart_button btn btn-light text-600" style="background-color:#F3F3F3">Out of Stock </button>
                                </td>
                            </tr>
                        </table>
                    </div>
        ...
        <section class="mt-5 also_bought">
            ...
            <div class="tab-content" style="min-height:100px" id="myTabContent">
              ...
              <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    <div class="row">
                        <div class="col-md-7">
                            <p class="text-700 " style="font-size:1.875vw">Sharps Container</p>
                            <ul class="" style="font-size:1.45vw">
                                <li class="p-0">Containers for used medical needles and other sharp medical instruments</li>
                                <li class="p-0">Designed so needles can be dropped in the container without touching the outside</li>
                                <li class="p-0">Commonly used in EMS, hospitals, nursing homes, clinics and doctors offices, etc.</li>
                                <li class="p-0">Transparent lid allows for visual monitoring of contents to avoid overfilling</li>
                                <li class="p-0">New Sharps Shaft is designed to hold syringes and conveniently fits into bags for EMS, fire and nursing personnel</li>
                            </ul>
                        </div>
                    </div>
